      ...
      <div className={styles.about_container}>
        ...
        <div className={styles.about_cards}>
          <div className={styles.card}>
            <div class={styles.front}>서비스 소개</div>
          ...
          <div className={styles.card}>
            <div class={styles.front}>튜토리얼</div>
            <div class={styles.back}>
          ...
          <div className={styles.card}>
            <div class={styles.front}>연습하기</div>
            <div class={styles.back}>
          ...
          <div className={styles.card}>
            <div class={styles.front}>도전하기</div>
            <div class={styles.back}>
          ...
          <div className={styles.card}>
            <div class={styles.front}>나의 정보</div>
            <div class={styles.back}>
