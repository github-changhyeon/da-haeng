...
public class TutorialMoveBusSceneWorld : MonoBehaviour
{
    public PathCreation.PathCreator pathCreator;
    public PathCreation.EndOfPathInstruction endOfPathInstruction;
    public float speed = 5;

    private TutorialOnBusController onBusController;
    ...
    void Start() {
        ...
        onBusController = GameObject.Find("BusForScene").GetComponent<TutorialOnBusController>();
    }

    void FixedUpdate()
    {
        if (pathCreator != null && onBusController._state == TutorialOnBusController.BusState.Drive)
        {
